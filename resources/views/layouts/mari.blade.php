        ...
        <div id="menu-iurankorpri-content" class="hidden mt-2 space-y-2 pl-2 md:pl-0">
            <div class="p-2 rounded-lg bg-gray-50 dark:bg-gray-900/50">
                ...
                <a href="{{ route('mari.rekon-iuran.index') }}"
                    class="block px-4 py-2 text-xs text-gray-600 dark:text-gray-400 hover:bg-slate-50 dark:hover:bg-gray-700 hover:text-blue-600 dark:hover:text-blue-400 rounded-md transition-colors {{ request()->routeIs('mari.rekon-iuran.index') ? 'text-blue-600 dark:text-blue-400 font-semibold bg-slate-50 dark:bg-gray-700' : '' }}">
                    Rekon Iuran Manual
                </a>
                <a href="{{ route('mari.eselon-mapping.index') }}"
                    class="block px-4 py-2 text-xs text-gray-600 dark:text-gray-400 hover:bg-slate-50 dark:hover:bg-gray-700 hover:text-blue-600 dark:hover:text-blue-400 rounded-md transition-colors {{ request()->routeIs('mari.eselon-mapping.*') ? 'text-blue-600 dark:text-blue-400 font-semibold bg-slate-50 dark:bg-gray-700' : '' }}">
                    Mapping Eselon
                </a>
