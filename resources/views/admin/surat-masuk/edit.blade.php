...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="flex items-center gap-2 mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Surat Masuk</h1>
        </div>

        <div class="max-w-3xl bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border-t-4 border-yellow-500">
            <form action="{{ route('mesra.surat-masuk.update', $suratMasuk->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">Ketik untuk mencari nama PD</p>
                        <input type="text" id="pengirim" name="pengirim"
                            value="{{ old('pengirim', $suratMasuk->pengirim) }}" list="pd-list" required
                            class="w-full px-4 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-gray-100 transition-all"
                            autocomplete="off">
                        <datalist id="pd-list">
                ...
                <div>
                    ...
                    <textarea id="disposisi" name="disposisi" rows="3"
                        class="w-full px-4 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-gray-100 transition-all">{{ old('disposisi', $suratMasuk->disposisi) }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="keterangan" name="keterangan" rows="2"
                        class="w-full px-4 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-gray-100 transition-all">{{ old('keterangan', $suratMasuk->keterangan) }}</textarea>
