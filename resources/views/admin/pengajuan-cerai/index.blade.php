                ...
                <form action="{{ route('admin.pengajuan-cerai.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="nama" name="nama" readonly
                                class="w-full rounded-md border-gray-300 bg-gray-100 dark:bg-gray-700 dark:text-gray-300 shadow-sm cursor-not-allowed text-sm">
                        </div>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="keterangan" rows="3"
                            class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm"></textarea>
                    </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr
                            ...
                            <th class="px-6 py-4 font-semibold border-b border-gray-100 dark:border-gray-600">Tanggal Surat
                            </th>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        @forelse($data as $index => $item)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">{{ $data->firstItem() + $index }}
                                </td>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">
                                    {{ $item->tanggal_surat->format('d/m/Y') }}</td>
                                <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $item->jenis_pengajuan === 'Penggugat' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200' : 'bg-orange-100 text-orange-800 dark:bg-orange-900 dark:text-orange-200' }}">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-8 text-center text-gray-500 dark:text-gray-400 italic">Belum ada
                                    data pengajuan.</td>
                            </tr>
                        @endforelse
                    </tbody>
