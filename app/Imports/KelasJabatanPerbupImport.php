...
class KelasJabatanPerbupImport implements ToCollection, WithHeadingRow
{
    ...
    public function collection(Collection $rows)
    {
        foreach ($rows as $index => $row) {
            ...
            try {
                // Gunakan nama_opd_perbup dan nama_jabatan_perbup sesuai dengan header excel
                RefKelasPerbup::updateOrCreate(
                    [
                        'nama_opd_perbup' => $opdName,
                        'nama_jabatan_perbup' => $jabatanName
                    ],
                    [
                        'kelas_jabatan' => $kelas
                    ]
                ...
                Log::error("KelasJabatanPerbupImport Error on Row {$rowNum}: " . $e->getMessage());
            }
        }
    }
